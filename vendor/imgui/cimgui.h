...
struct ImVector_ImGuiStorage_ImGuiStoragePair_t { int Size; int Capacity; ImGuiStorage_ImGuiStoragePair* Data; };  // Instantiation of ImVector<ImGuiStorage_ImGuiStoragePair>
...
// [Internal]
struct ImGuiStorage_ImGuiStoragePair_t
{
    ImGuiID key;
    union
    {
